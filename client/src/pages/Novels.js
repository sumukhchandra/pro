    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Error loading novels</h2>
          <p className="text-gray-600 mb-4">Something went wrong while loading the novels.</p>
          <button 
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Novels</h1>
          <p className="text-gray-600">Discover amazing novels from talented writers</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">No novels found</h2>
            <p className="text-gray-600 mb-6">
              {filters.search 
                ? `No novels match your search for "${filters.search}"`
